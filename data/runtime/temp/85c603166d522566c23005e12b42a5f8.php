<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:53:"./application/admin/template/public\dispatch_jump.htm";i:1582786098;}*/ ?>
                ...
                success:function(res){
                    ...
                    $.ajax({
                        ...
                        success:function(res){
                            ...
                            $('#tips').html('');
                            // 百度自动推送
                            push_zzbaidu('<?php echo $arcurl_home; ?>', '<?php echo $action_name; ?>');
                            // 更新sitemap.xml地图
                            update_sitemap('<?php echo $ctl_name; ?>', '<?php echo $action_name; ?>');
                        },
                        error: function(e){
                            layer.closeAll();
